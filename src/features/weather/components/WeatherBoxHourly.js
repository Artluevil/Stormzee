            ...
            <div className="weather-box-hourly-container">
                ...
                <div className="weather-box-hourly-wrapper">
                    <div className="weather-box-hourly-morning">
                        ...
                        <img src={"http://openweathermap.org/img/wn/" + dataHourly.data.hourly[14].weather[0].icon + "@2x.png"} alt="weather icon"/>
                    ...
                    <div className="weather-box-hourly-afternoon">
                        ...
                        <img src={"http://openweathermap.org/img/wn/" + dataHourly.data.hourly[20].weather[0].icon + "@2x.png"} alt="weather icon"/>
                        <p className="weather-box-hourly-morning-humidity-name">Humidity</p>
                    ...
                    <div className="weather-box-hourly-evening">
                        ...
                        <img src={"http://openweathermap.org/img/wn/" + dataHourly.data.hourly[27].weather[0].icon + "@2x.png"} alt="weather icon"/>
                        <p className="weather-box-hourly-morning-humidity-name">Humidity</p>
                    ...
                    <div className="weather-box-hourly-overnight">
                        ...
                        <img src={"http://openweathermap.org/img/wn/" + dataHourly.data.hourly[31].weather[0].icon + "@2x.png"} alt="weather icon"/>
                        <p className="weather-box-hourly-morning-humidity-name">Humidity</p>
